...
export function ChatPanel({ slug, agreementName, onFieldsExtracted, onSwitchToForm }: ChatPanelProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* Footer: switch link + input */}
      <div className="border-t border-gray-200 bg-white px-4 py-3">
        <button
          onClick={onSwitchToForm}
          className="mb-2 text-xs text-brand-gray hover:text-brand-blue transition-colors"
        >
          Switch to manual form &rarr;
        </button>
